...
/**
 * Servlet implementation class DoEditServiceEntry
 */
@WebServlet("/DoEditServiceEntry")
public class DoEditServiceEntry extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DoEditServiceEntry() {
        super();
	...
	/**
	 * Requests service entry edits, and updates the database with
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ServiceEntry s = (ServiceEntry) session.getAttribute("seToEdit");
                
        try {
			seDAO.editServiceEntry(s.getID(), desc, date, cost, mileage);
